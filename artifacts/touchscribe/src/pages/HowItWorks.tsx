...
const SERVICES = [
  {
    ...
    how: "A trained scribe joins each encounter via a HIPAA-compliant audio connection. Using AI to capture key phrases and your specialty templates, they complete a draft note in real time. A human QA reviewer checks every note before it enters your EHR.",
  },
  {
    icon: FileText,
    color: "bg-blue-50",
    ...
    how: "We work inside your existing EHR — Epic, Cerner, Athena, or 50+ others. Our team follows your specialty's documentation standards, ensuring every record is structured, consistent, and audit-ready. No template changes required.",
  },
  {
    icon: ShieldCheck,
    color: "bg-amber-50",
    ...
    how: "When a PA is triggered, our authorization team pulls the clinical documentation, completes the submission form, and tracks it to decision. We handle peer-to-peer calls, appeals, and RFA resubmissions — keeping care on schedule.",
  },
  {
    icon: Receipt,
    color: "bg-violet-50",
    ...
    how: "From charge capture to payment posting, our billing team handles the full cycle. We code encounters, submit clean claims, follow up on outstanding balances, and manage denials — giving you predictable cash flow without the back-office overhead.",
  },
];
